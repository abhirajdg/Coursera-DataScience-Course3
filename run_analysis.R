...
# Collecting files from respective directory
uci_dir <- "UCI-Dataset"
...
final_analysis = ddply(sensor_data_mean_std, c("Subject","Activity"), numcolwise(mean))
write.table(final_analysis, file = "final_analysis.txt", row.names = FALSE)